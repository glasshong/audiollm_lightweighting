...
from transformers import AutoModelForCausalLM, QuantizedCacheConfig, GenerationConfig

# Custom modules
from salmonn_utils_gemma2 import SALMONNTestDataset, load_preprocessor, load_model
...
def main(args):
    ...
    gemma_model, tokenizer = load_model(salmonn_preprocessor)
    ...
    for samples in tqdm(dataloader):
        ...
        bos_embeds = gemma_model.model.model.embed_tokens(bos)
        ...
        # hidden_dim = gemma_model.config.hidden_size
        ...
        #     axis_value=0, 
        #     q_group_size=64,
        #     residual_length=256 if embeds.shape[1] > 3000 else 128
        # )
        ...
        # Generation
        outputs = gemma_model.model.generate(
            inputs_embeds=embeds,
            pad_token_id=gemma_model.config.eos_token_id[0],
