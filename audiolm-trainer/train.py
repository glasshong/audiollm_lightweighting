...
from models import load_model_gemma2
...
def main():
    ...
    # global_rank = int(os.environ["RANK"])  # 분산 학습 사용 시
    global_rank = int(os.environ.get("RANK", 1)) # 분산 학습 미사용시
    ...
    # build model
    if not args.dryrun:
        model = load_model_gemma2(model_config)
